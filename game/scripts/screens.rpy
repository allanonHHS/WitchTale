...
init:
    # image start = 'images/intro.png'
    image start = Movie(channel="main_menu", play="images/intro.webm")
    $ avCorr = 0
...
#    style.menu_choice_button.xmaximum = int(config.screen_width * 0.75)
    ...
    style.menu_choice.clear()
    style.menu_choice_button.set_parent(style.button)
    style.menu_choice_button.xminimum = int(config.screen_width * 0.35)
    style.menu_choice_button.xmaximum = int(config.screen_width * 0.35)
    style.menu_choice_button.xpos = 850
    ...
    grid 3 1:
        ...
        vbox:
            ...
            frame:
                style_group "pref"
                has vbox
                text _('Допустимая разница в силе зелий')
                hbox:
                     textbutton _("5") action [SetVariable('strengthAdj',5), SelectedIf(strengthAdj == 5) ,Show('preferences')] xmaximum 50
                     textbutton _("15") action [SetVariable('strengthAdj',15), SelectedIf(strengthAdj == 15) ,Show('preferences')] xmaximum 50
                     textbutton _("25") action [SetVariable('strengthAdj',25), SelectedIf(strengthAdj == 25) ,Show('preferences')] xmaximum 50
                     textbutton _("50") action [SetVariable('strengthAdj',50), SelectedIf(strengthAdj == 50) ,Show('preferences')] xmaximum 50
                     textbutton _("100") action [SetVariable('strengthAdj',100), SelectedIf(strengthAdj == 100) ,Show('preferences')] xmaximum 50
            frame:
                style_group "pref"
                has vbox
                text _('Эмпатия всегда срабатывает в просьбах')
                hbox:
                    textbutton _("Вкл") action [SetVariable('empathyAdj',100), SelectedIf(empathyAdj == 100) ,Show('preferences')] xmaximum 100
                    textbutton _("Выкл") action [SetVariable('empathyAdj',0), SelectedIf(empathyAdj == 0) ,Show('preferences')] xmaximum 100
            frame:
                style_group "pref"
                has vbox
                text _('Сила внушения')
                hbox:
                     textbutton _("5") action [SetVariable('infusionMod',5), SelectedIf(infusionMod == 5) ,Show('preferences')] xmaximum 50
                     textbutton _("10") action [SetVariable('infusionMod',10), SelectedIf(infusionMod == 10) ,Show('preferences')] xmaximum 50
                     textbutton _("25") action [SetVariable('infusionMod',25), SelectedIf(infusionMod == 25) ,Show('preferences')] xmaximum 50
                     textbutton _("50") action [SetVariable('infusionMod',50), SelectedIf(infusionMod == 50) ,Show('preferences')] xmaximum 50
