init python:
    ...
    style.navigation_button_text.font = "Izhitsa Normal.ttf"
    ...
    style.action_button_text.font = "Izhitsa Normal.ttf"
...
style bigRed is text:
    size 50
    font 'MIROSLN.ttf'
    outlines [(2, "#000000", 0, 0)]
    color "#FF1E1E"
    
style normalRed is text:
    size 25
    font 'MIROSLN.ttf'
    outlines [(2, "#000000", 0, 0)]
    color "#FF1E1E"
    
style effects is text:
    size 18
    font 'Izhitsa Normal.ttf'
    color "#FFFFFF"
    outlines [(1, "#494949", 0, 0)]
